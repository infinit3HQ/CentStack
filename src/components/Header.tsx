...
function EncryptionBadge() {
  ...
  if (!isEnabled) {
    return (
      ...
      >
        ...
        <span className="font-mono text-[9px] uppercase tracking-widest">enc::off</span>
      </button>
    );
  }
  ...
  if (isEnabled && !isUnlocked) {
    return (
      ...
      >
        ...
        <span className="font-mono text-[9px] uppercase tracking-widest">enc::locked</span>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <span className="font-mono text-[9px] uppercase tracking-widest">enc::aes-256</span>
    </div>
  );
}
